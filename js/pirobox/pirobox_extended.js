...
(function($) {
	...
	var struct =(
		...
		'<div class="piro_next_fake">Next</div>'+
               ' <div id="mac_close" style="color:#fff;margin-left:450px;float:left;display:none;position:absolute">Close</div>'+
                '<div id="mac_cross" class="piro_close" title="Close" onMouseOver="toggleDiv(1)" onMouseOut="toggleDiv(0)"></div>'+
		'</div>'+
                '<div class="clear"></div>'+
