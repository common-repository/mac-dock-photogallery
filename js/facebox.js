...
(function($) {
  ...
  $.extend($.facebox, {
    settings: {
      ...
      opacity      : 0,
      overlay      : true,
      loadingImage : url+'/wp-content/plugins/mac-dock-photogallery/images/facebox/loading.gif',
      closeImage   : url+'/wp-content/plugins/mac-dock-photogallery/images/facebox/close.gif',
